...
export const TAUNTS: readonly TauntTemplate[] = [
  ...
  { id: "l1_win_04", level: 1, context: "win", title: "Küçük bir hatırlatma", body: "{winner} {challenge} çelıncını kazandı. Sen {loserScore} {unit} yaptın, gayet iyi. Ama {winnerScore} biraz daha iyi." },
  ...
  { id: "l1_winbig_01", level: 1, context: "win_big", title: "Fark biraz açıldı", body: "{winner} {winnerScore} {unit}, sen {loserScore} {unit}. Aradaki {diff} {unit} tek başına ayrı bir çelınc olurdu." },
  { id: "l1_winbig_02", level: 1, context: "win_big", title: "Ders niteliğinde", body: "{winner} {challenge} çelıncında resmen ders anlattı: {winnerScore} vs {loserScore}. Sen arka sırada uyumuşsun." },
  ...
  { id: "l1_streak_01", level: 1, context: "streak", title: "Seri devam ediyor", body: "{winner} {challenge} çelıncını yine kazandı. Üst üste. {loser}, bu artık bir alışkanlık: onun için kazanmak, senin için izlemek." },
  ...
  { id: "l2_win_02", level: 2, context: "win", title: "Yedin kanka", body: "{winner} seni {challenge} çelıncında {diff} {unit} ile paketledi. Hani sen iddialıydın? İddia kaldı, sen yedin." },
  ...
  { id: "l2_win_07", level: 2, context: "win", title: "Bahane hazır mı?", body: "{winner} {challenge} çelıncını aldı: {winnerScore} vs {loserScore}. Bahaneni hazırla lan, grup birazdan soracak." },
  ...
  { id: "l2_winbig_01", level: 2, context: "win_big", title: "Silindir geçti lan", body: "{winner} {winnerScore}, sen {loserScore}. {diff} {unit} fark. Bu çelınc değil, üstünden silindir geçti. Yedin {loser}." },
  { id: "l2_winbig_02", level: 2, context: "win_big", title: "Sen katıldın mı ki?", body: "{winner} {challenge} çelıncında uçtu, sen {loserScore} {unit} ile kaldın. Telefonu evde mi unuttun lan?" },
  ...
  { id: "l2_poke_05", level: 2, context: "poke", title: "Kanepe seni yendi", body: "{loser}, {metric} skorun donmuş. {winner} diyor ki: kanepeyle çelınc yapmıyoruz lan, benimle yapıyorsun. Kalk." },
  ...
  { id: "l3_win_02", level: 3, context: "win", title: "Kökledi lan", body: "{winner} {challenge} çelıncında sana kökledi: {winnerScore} vs {loserScore}. Fidan diksen bu kadar kökleşmezdi {loser}." },
  ...
  { id: "l3_win_05", level: 3, context: "win", title: "Girdi çıktı", body: "{winner} {challenge} çelıncına girdi, koydu, çıktı. Sen hâlâ {loserScore} {unit} ile yatıyorsun {loser}. Kapıyı da açık bıraktı." },
  ...
  { id: "l3_winbig_02", level: 3, context: "win_big", title: "Tren geçti üstünden", body: "{winner} {challenge} çelıncında sana {diff} {unit} fark attı. Sen katılmadın, ezildin. Tren geçti lan, vagonlar hâlâ geçiyor." },
