...
/// Result of applying a completed session's errorCount to an existing
/// [ScheduleEntry]. Returns a NEW entry — callers must persist it.
///
...
ScheduleEntry onCompletion(
  ...
  final newDifficulty = nextDifficulty(
