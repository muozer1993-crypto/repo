/**
 * TODO: owned by the route agent for these endpoints — GET /challenges, POST /challenges, GET /challenges/:id, POST /challenges/:id/accept|decline|leave|cancel.
...
export default async function challengeRoutes(_app: FastifyInstance): Promise<void> {
  // no routes yet
}
