/**
 * TODO: owned by the route agent for these endpoints — POST /auth/register, POST /auth/login.
...
export default async function authRoutes(_app: FastifyInstance): Promise<void> {
  // no routes yet
}
