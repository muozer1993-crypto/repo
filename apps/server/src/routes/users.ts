/**
 * TODO: owned by the route agent for these endpoints — GET /users/search, GET /users/:id, POST /users/:id/block|unblock|report.
...
export default async function userRoutes(_app: FastifyInstance): Promise<void> {
  // no routes yet
}
