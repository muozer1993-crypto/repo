/**
 * TODO: owned by the route agent for these endpoints — POST /challenges/:id/entries, DELETE /challenges/:id/entries/:entryId, POST /challenges/:id/entries/:entryId/dispute.
...
export default async function entryRoutes(_app: FastifyInstance): Promise<void> {
  // no routes yet
}
