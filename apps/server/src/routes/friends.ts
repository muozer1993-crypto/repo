/**
 * TODO: owned by the route agent for these endpoints — GET /friends, POST /friends/request, POST /friends/:friendshipId/accept|decline, DELETE /friends/:userId.
...
export default async function friendRoutes(_app: FastifyInstance): Promise<void> {
  // no routes yet
}
